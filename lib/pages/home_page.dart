...
class _HomePageState extends State<HomePage> {
  final _menuItems = [
    ...
    {'label': 'Listar Materias', 'route': 2},
    {'label': 'Agregar Materia', 'route': 3},
...
//    {'label': 'Eliminar Usuario', 'route': 3},
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('CRUD con MOOR y con SQLite'),
      ),
  ...
  Widget _getContentWidget() {
    switch (_selectedPage) {
      ...
      case 1:
        return ListUserPage();
      case 2:
        return ListMateriaPage();
      case 3:
        return AddMateriaPage();
